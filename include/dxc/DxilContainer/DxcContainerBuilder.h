...
public:
  ...
  HRESULT STDMETHODCALLTYPE SerializeContainer(_COM_Outptr_ IDxcOperationResult **ppResult) override; // Builds a container of the given container builder state
